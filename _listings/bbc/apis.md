...
- name: 'BBC Nitro - Look inside programmes to find segments: chapters, tracks and
    more'
...
- name: 'BBC Nitro - Find the people behind and in programmes: cast, crew, guests
    and more'
...
- name: BBC Nitro - Exposes programme information for a single pid
  x-api-slug: programme-details-get
...
- name: BBC Nitro - Get raw brand franchise
  x-api-slug: v1brandspidfranchises-get
...
- name: BBC Nitro - Get raw formats
  x-api-slug: v1episodespidformats-get
...
- name: BBC Nitro - Get raw masterbrand
  x-api-slug: v1master-brandsmbid-get
